...
class Init_AddTwoInts_Response_result
{
public:
  Init_AddTwoInts_Response_result()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::interfaz_servicio_suma::srv::AddTwoInts_Response result(::interfaz_servicio_suma::srv::AddTwoInts_Response::_result_type arg)
  {
...
{
  return interfaz_servicio_suma::srv::builder::Init_AddTwoInts_Response_result();
}
